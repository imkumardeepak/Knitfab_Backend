...
{
    /// <inheritdoc />
    public partial class rolShiftAssign : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedRolls = table.Column<int>(type: "integer", nullable: false),
                    GeneratedStickers = table.Column<int>(type: "integer", nullable: false),
                    RemainingRolls = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShiftRollAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShiftRollAssignments_MachineManagers_MachineId",
                        column: x => x.MachineId,
                        principalTable: "MachineManagers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShiftRollAssignments_ShiftMasters_ShiftId",
                        column: x => x.ShiftId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftRollAssignments_MachineId",
                table: "ShiftRollAssignments",
                column: "MachineId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftRollAssignments_ShiftId",
                table: "ShiftRollAssignments",
                column: "ShiftId");
